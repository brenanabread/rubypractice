...
when 6
puts "your numerology is #{number}.\nThis is the peace lover. The number six is a loving, stable, and harmonious viaibration. Rule by Venus."
when 7
puts "Your numerology number is #{number}.n\This is the deep thinker. The number seven is a spiritual vibration. These people are not verey attached to material things, are introspective, and generally quiet. Ruled by Neptune."
when 8
puts "your numerology number is #{number}.\n
else
[D[Dend
